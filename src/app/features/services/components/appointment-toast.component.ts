...
@Component({
  ...
  template: `
    ...
    <div @slideUp class="fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-3xl max-h-[82vh] flex flex-col">
      ...
      <div class="px-6 pt-2 pb-4 border-b border-white-sanity/50 flex-shrink-0">
        <div class="flex items-center gap-3 mb-3">
          ...
          <button (click)="close()" class="w-9 h-9 rounded-full bg-white-sanity/40 flex items-center justify-center flex-shrink-0">
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()"
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-2">
            <button type="button" *ngFor="let tipo of specialist.servicios"
        ...
        <!-- Error -->
        <div *ngIf="errorMsg" class="bg-red-50 border border-red-200 rounded-xl px-4 py-3 text-sm text-red-500">
          {{ errorMsg }}
        </div>
